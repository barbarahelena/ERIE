...
scripts/
  ...
  04_compare_to_former_model.R  R2 comparison with the former model
  assets/
...
results/                 fit tables and plots (generated by 02, 03 and 04)
docs/
...
pixi run compare-former # results/ -> R2 comparison with the former model
